...
First go to the Settings section of your repository.<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/settings.png" alt="Repository settings" width="800"/>

Second edit the Repository name under the general settings tab to match the naming convention needed.<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/Repo-name.png" alt="edit repository name" width="800"/>

Second is the structure of the page. below is an example of the structure.<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/folder-structure.png" alt="folder strucutre diagram" width="800"/>
...
Firstly, go to your repository on GitHub.com and click on the settings section at the top.<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/settings.png" alt="Repository settings page" width="800"/>

Next on the left hand side you want to click on Pages under the Code and automation tab.<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/setting-sections.png" alt="pages settings" width="400"/>
...
Below is an image of the settings you should have in the pages section. [If you have a custom domain sorted already you can use this custom domain name.](#using-a-custom-domain-name)<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/pages-settings.png" alt="pages configuration" width="600"/>

After a few minutes your page should now be hosted on GitHub pages ready for you to share. Once the page is done you will have section at the top that will appear showing you the name of the page and if you want to stop hosting it.<br>
<img src="https://raw.githubusercontent.com/sarah-cic-uk/Code-the-Future/main/images/session1/site-url.png" alt="site url" width="800"/>
