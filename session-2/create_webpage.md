...
If you get stuck or would like some inspiration on what to add to your page, you can check out the <a href='./example-finished-activities/index_section_02_example.html' target='_blank'>example finished activity</a>.
